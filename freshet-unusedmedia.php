...
define('FRESHET_UNUSEDMEDIA_VERSION', '1.0.6');
    ...
    add_action('admin_notices', static function (): void {
        printf(
            ...
            esc_html(sprintf(
                ...
                __('Freshet Unused Media requires PHP 8.1 or newer. This site runs PHP %s — the plugin is inactive.', 'freshet-unused-media'),
                PHP_VERSION
            ))
        );
    });
